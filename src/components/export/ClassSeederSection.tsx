...
import {
  importClassGoat25052026,
  isClassGoat25052026ImportDone,
} from '../../services/class25052026ImportService';
...
const CLASS_ENTRIES: ClassEntry[] = [
  {
    label: 'Clase GOAT 25/05/2026',
    description: 'Movilidad de tobillo + Activación tren inferior + Fuerza Box Jump/Front Squat + WOD Jump Rope/Power Clean/T2B/Burpee',
    isDone: isClassGoat25052026ImportDone,
    run: importClassGoat25052026,
  },
];
